...
/*
 This is the actual design of the card in the HomeView
 */
struct CardDisplayView: View, Identifiable {
    let id: UUID = UUID()
    let user: User
    ...
    var body: some View {
        //The GeometryReader is used to more accurately display the layout position of the card display view https://developer.apple.com/documentation/swiftui/geometryreader
...
//        CardDisplayView(user: User.mockUsers[0]) {
//        }
//    }
//}
